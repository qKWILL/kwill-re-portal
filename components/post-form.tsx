...
const POST_TYPES = [
  {
    value: "blog",
    label: "Blog Post",
    desc: "Full article with rich text editor",
  },
  ...
  { value: "linkedin", label: "LinkedIn", desc: "Share a LinkedIn post" },
  {
    value: "podcast",
    label: "Podcast",
    desc: "Embed a YouTube/podcast episode",
  },
];
      ...
      <section className="bg-white border border-gray-200 rounded-lg p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => {
                ...
                if (e.target.value) clearError("excerpt");
              }}
              rows={3}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (e.target.value) clearError("external_url");
              }}
              className={fieldClass("external_url")}
              placeholder="https://..."
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (e.target.value) clearError("youtube_url");
              }}
              className={fieldClass("youtube_url")}
        ...
        <div>
          ...
          {imgUrl ? (
            ...
            <label
              className={`flex items-center gap-2 cursor-pointer border-2 border-dashed rounded-lg p-4 hover:border-gray-400 transition-colors ${errors.img_url ? "border-red-400" : "border-gray-300"}`}
            >
              {uploadingImage ? (
...
const BlogEditor = forwardRef(function BlogEditor(
  ...
  if (!mounted)
    return (
      <div className="h-[250px] bg-gray-50 rounded border border-gray-200 animate-pulse" />
    );
